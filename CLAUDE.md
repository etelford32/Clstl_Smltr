...
- **`hss_events`, `hss_arrival_forecasts`, `hss_l1_observations`** (migration `hss_validation_program`, 2026-07-23) — the HSS/corotation half of the same validation program; same zero-policy, service-role-only pattern, same intentional advisor flag. See `CME_FORECAST_VALIDATION_PLAN.md` Phase 7.
