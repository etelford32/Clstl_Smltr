export class FieldAtlas {
    static __wrap(ptr) {
        const obj = Object.create(FieldAtlas.prototype);
        obj.__wbg_ptr = ptr;
        FieldAtlasFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FieldAtlasFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_fieldatlas_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get line_count() {
        const ret = wasm.fieldatlas_line_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    meta() {
        try {
            ...
            wasm.fieldatlas_meta(retptr, this.__wbg_ptr);
     ...
     */
    get meta_stride() {
        const ret = wasm.fieldatlas_meta_stride(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    positions() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.fieldatlas_positions(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayF32FromWasm0(r0, r1).slice();
            wasm.__wbindgen_export4(r0, r1 * 4, 4);
     ...
     * @returns {number}
     */
    get samples_per_line() {
        const ret = wasm.fieldatlas_samples_per_line(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {Float32Array}
    ...
    tangents() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.fieldatlas_tangents(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayF32FromWasm0(r0, r1).slice();
            wasm.__wbindgen_export4(r0, r1 * 4, 4);
...
if (Symbol.dispose) FieldAtlas.prototype[Symbol.dispose] = FieldAtlas.prototype.free;
 ...
 * @returns {FieldAtlas}
 */
export function compute_field_lines(input) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.compute_field_lines(retptr, addHeapObject(input));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
 ...
 * @returns {Uint32Array}
 */
export function debug_counts(input) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.debug_counts(retptr, addHeapObject(input));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./sunfield_wasm_bg.js": import0,
    };
}

const FieldAtlasFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_fieldatlas_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sunfield_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
