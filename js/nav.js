...
const NAV_DROPDOWNS = [
    ...
    },
    {
        ...
        items: [
            ...
            { href: 'storm-observatory.html', label: 'Storm Observatory', sub: 'Three thermospheric storms · one LEO catalog · τ-synced', tier: 'free', icon: '🛰️', badge: 'NEW', id: 'storm-observatory' },
