...
export const EARTH_OBS_LAYERS = [
    ...
    {
        id:          'nightlights',
        gibs:        'VIIRS_SNPP_DayNightBand_At_Sensor_Radiance',
        name:        'Nighttime Lights',
        category:    'land',
        description: 'VIIRS Day/Night Band — city lights, fishing fleets, gas flares',
        unit:        'nW/cm²/sr',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~12 hours (daily composite)',
        colorRamp:   'Dark (no light) → yellow → white (bright)',
        format:      'image/png',
        timeOffset:  1,
    },
    {
        id:          'sea-ice',
        gibs:        'AMSR2_Sea_Ice_Concentration_12km',
        name:        'Sea Ice Concentration',
        category:    'cryosphere',
        description: 'GCOM-W1 AMSR2 passive microwave sea ice concentration (Arctic + Antarctic)',
        unit:        '% coverage',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~1 day',
        colorRamp:   'Blue (open water) → cyan → white (solid ice)',
        format:      'image/png',
        timeOffset:  1,
    },
    {
        ...
        category:    'land',
        description: 'MODIS 8-day composite vegetation health — green = healthy, brown = stressed',
        unit:        'dimensionless (-1 to +1)',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~2-8 days (8-day composite)',
        colorRamp:   'Brown (bare/stressed) → yellow → green (healthy) → dark green (dense)',
        format:      'image/png',
        timeOffset:  2,
    },
    {
        id:          'ozone',
        gibs:        'OMPS_NPP_Total_Column_Ozone',
        name:        'Total Ozone Column',
        category:    'atmosphere',
        description: 'OMPS ozone layer thickness — tracks ozone hole over Antarctica',
        unit:        'Dobson Units (DU)',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~1 day',
        colorRamp:   'Purple (thin, <220 DU ozone hole) → blue → green → yellow (thick, >400 DU)',
        format:      'image/png',
        timeOffset:  1,
    },
    {
        id:          'dust',
        gibs:        'OMPS_NPP_Aerosol_Index',
        name:        'Aerosol/Dust Index',
        category:    'atmosphere',
        description: 'OMPS UV aerosol index — Saharan dust, volcanic ash, wildfire smoke plumes',
        unit:        'dimensionless',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~1 day',
        colorRamp:   'Clear → yellow → orange → red → brown (dense dust/smoke)',
        format:      'image/png',
        timeOffset:  1,
    },
    {
        id:          'chlorophyll',
        gibs:        'MODIS_Terra_Chlorophyll_A',
        name:        'Ocean Chlorophyll-a',
        category:    'ocean',
        description: 'MODIS ocean colour — phytoplankton productivity, algal blooms',
        unit:        'mg/m³',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~2 days',
        colorRamp:   'Purple (oligotrophic) → blue → green → yellow → red (bloom)',
        format:      'image/png',
        timeOffset:  2,
    },
    {
        id:          'lst-day',
        gibs:        'MODIS_Terra_Land_Surface_Temp_Day',
        name:        'Land Surface Temp (Day)',
        category:    'land',
        description: 'MODIS daytime land surface temperature — heat islands, desert heat',
        unit:        '°C',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~1 day',
        colorRamp:   'Blue (cold) → cyan → green → yellow → orange → red (hot)',
        format:      'image/png',
        timeOffset:  1,
    },
    {
        id:          'water-vapor',
        gibs:        'AIRS_L2_Total_Water_Vapor_A',
        name:        'Atmospheric Water Vapor',
        category:    'atmosphere',
        description: 'AIRS total precipitable water — moisture transport, atmospheric rivers',
        unit:        'kg/m²',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~1 day',
        colorRamp:   'Brown (dry) → yellow → green → blue → purple (moist)',
        format:      'image/png',
        timeOffset:  1,
    },
    {
        id:          'coral-bleach',
        gibs:        'CRW_Bleaching_Alert_Area_7d',
        name:        'Coral Bleaching Alert',
        category:    'ocean',
        description: 'NOAA Coral Reef Watch — 7-day bleaching thermal stress alert areas',
        unit:        'alert level (0-4)',
        resolution:  { w: 2048, h: 1024 },
        cadence:     24 * 60 * 60_000,
        latency:     '~1 day (7-day composite)',
        colorRamp:   'No stress → watch (yellow) → warning (orange) → alert 1 (red) → alert 2 (dark red)',
        format:      'image/png',
        timeOffset:  1,
    },
    {
        id:          'lightning-glm',
        gibs:        'GOES_East_GLM_Flash_Extent_Density',
        name:        'Lightning (GOES GLM)',
        category:    'atmosphere',
        description: 'GOES-16 Geostationary Lightning Mapper — flash density (Americas only)',
        unit:        'flashes/km²',
        resolution:  { w: 2048, h: 1024 },
        cadence:     10 * 60_000,
        latency:     '~10 minutes',
        colorRamp:   'Transparent → yellow → orange → red → white (intense)',
        format:      'image/png',
        timeOffset:  0,
    },
];
