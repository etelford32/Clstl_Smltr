...
import { FlareRing } from './flare-ring.js';
...
export class SunRenderer2D {
    ...
    _drawFlares(ctx, cx, cy, R) {
        this._flareRing.draw(ctx, cx, cy, R,
            (lat, lon) => this._project(lat, lon, cx, cy, R));
    }
}
